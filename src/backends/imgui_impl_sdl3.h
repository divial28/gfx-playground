...
// backends!
IMGUI_IMPL_API bool ImGuiSDL3InitForOpenGL(SDL_Window* window,
                                           void*       sdlGlContext);
...
IMGUI_IMPL_API bool ImGuiSDL3InitForSDLRenderer(SDL_Window*   window,
...
enum ImGuiSDL3GamepadMode
{
    ImGuiSDL3_GamepadMode_AutoFirst,
    ImGui_ImplSDL3_GamepadMode_AutoAll,
    ImGui_ImplSDL3_GamepadMode_Manual
};
IMGUI_IMPL_API void ImGuiSDL3SetGamepadMode(ImGuiSDL3GamepadMode mode,
                                            SDL_Gamepad** manualGamepadsArray
                                            = nullptr,
                                            int manualGamepadsCount = -1);
